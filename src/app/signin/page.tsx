      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
          ...
          <div className="mb-8 text-center">
            <Link
              href="/"
              className="inline-block font-brand text-3xl text-foreground cursor-pointer"
            >
              Mail Detective
            </Link>
            <p className="mt-1 font-mono text-[10px] uppercase tracking-[0.25em] text-muted-foreground">
              every email investigated
            </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading || isGoogleLoading || isGithubLoading}
              className="flex items-center justify-center gap-2 h-12 w-full rounded-xl bg-primary font-brand font-medium text-primary-foreground transition-all duration-300 hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
              {isLoading && (
                <div className="h-5 w-5 animate-spin rounded-full border-2 border-current border-t-transparent" />
              )}
